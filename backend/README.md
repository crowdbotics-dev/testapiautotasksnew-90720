...
## Project Structure
    ...
    ├── testapiautotasksnew_90720  # Django project configurations
...
1. Clone this repo and `cd testapiautotasksnew_90720`
...
2. Clone this repo and `cd testapiautotasksnew_90720`
